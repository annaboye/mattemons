...
<div className="about-wrapper">
    ...
    <ol>
        ...
        <li>Välj din pokémon som du vill ska utvecklas bland 5 stycken slumpmässiga.</li>
        <li>Välj räknesätt och nivå.</li>
        <li>Om du klarar spelet utvecklas din pokemon; annars kan du försöka igen.</li>
        <li>Alla pokémon som utvecklas sparas i din samling. Om du klickar på pokebollen uppe i högra hörnet kan du besöka dessa.</li>
    </ol>
    <h2>Om Mattemons:</h2>
